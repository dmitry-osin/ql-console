...
if (rconPort) {
    ...
    rcon_1.onConnectRetried(function () { 
        console.log("".concat(resolveColor('bright'), "Reconnecting to rcon API failed...").concat(resolveColor('reset'))); 
        process.exit(1);
    });
...
if (statsPort) {
    ...
    stats.onConnectRetried(function () { 
        console.log("".concat(resolveColor('bright'), "Reconnecting to stats API failed...").concat(resolveColor('reset'))); 
        process.exit(1);
    });
